...
evaluation_inputs = [
    '你好，你是谁？', '采煤工作面落煤时产尘点下风侧10m~15m处总粉尘降尘效率应大于或等于多少？','2023年3月26日发生了什么事故？','下面是个单选题，请你选择正确选项。单选题：关于《安全生产法》的立法目的，下列表述中不准确的是( ) A.加强安全生产工作  C.保障人民群众生命和财产安全  B.防止和减少生产安全事故 D.提升经济发展速度','请简述煤矿顶板冒落的预防措施？'
]
